      ...
      <div className="section-container w-full">
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass text-xs font-medium text-accent mb-8"
          >
          ...
          >
            ...
            <span className="block mt-2 text-2xl sm:text-3xl md:text-4xl text-text-secondary font-medium">
          ...
          <motion.p
            ...
            className="mt-4 text-base text-text-muted italic"
          >
